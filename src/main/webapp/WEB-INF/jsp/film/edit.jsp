					...
					<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<form:form modelAttribute="edit_film_attr"  method="post" action="${pageContext.request.contextPath }/film/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									<label for="minutiDurata" class="form-label">Durata in minuti <span class="text-danger">*</span></label>
									<spring:bind path="minutiDurata">
										<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="minutiDurata" id="minutiDurata" placeholder="Inserire durata Film" value="${edit_film_attr.minutiDurata }" required>
									</spring:bind>
